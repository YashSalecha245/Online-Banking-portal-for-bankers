                        ...
                        <div class="col-sm-7">
                        	...
                        	<div class="form-box" >
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="Transfer" method="post" class="registration-form">
				                        ...
				                        <div class="form-group">
				                    		<label class="sr-only" for="form-first-name">Receiver Account Id</label>
				                        	<i class="glyphicon glyphicon-pencil"></i><strong> Receiver Account Id</strong><input type="password" name="destinationid" placeholder="Receiver Account Id..." class="form-first-name form-control" id="form-first-name">
				                        </div>
				                        <div class="form-group">
				                        	...
				                        	<i class="glyphicon glyphicon-piggy-bank"></i><strong> Amount</strong><input type="text" name="amount" placeholder="Amount..." class="form-first-name form-control" id="form-first-name">
                                                        ...
                                                        <button type="submit" class="btn">Transfer Money</button><br><br></form>
